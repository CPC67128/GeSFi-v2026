...
export function WithdrawalForm({ placementAccountId, accounts }: Props) {
  const t = useTranslations("WithdrawalForm");
  const action = createWithdrawal.bind(null, placementAccountId);
    ...
    <form action={formAction} className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <DatePicker name="debit_date" defaultValue={today} onSelect={setArrivalDate} />
        </div>
        <div className="space-y-2">
