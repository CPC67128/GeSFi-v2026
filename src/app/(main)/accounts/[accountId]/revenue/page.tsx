...
import { RevenueForm, type AccountOption } from "./revenue-form";
...
export default async function RevenuePage({ params }: Props) {
  ...
  const t = await getTranslations("RevenuePage");
  ...
  return (
    <div className="p-4 md:p-6 max-w-2xl">
      ...
      <RevenueForm placementAccountId={accountId} accounts={accounts} />
    </div>
  );
}
